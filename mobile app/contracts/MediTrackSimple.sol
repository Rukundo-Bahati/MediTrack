...
/**
 * @title MediTrackSimple
 * @dev Simplified smart contract for pharmaceutical supply chain tracking
 * @notice This contract manages medicine batch registration and verification without external dependencies
 */
contract MediTrackSimple {
    ...
    ) external onlyRegisteredUser onlyRole(UserRole.MANUFACTURER) {
